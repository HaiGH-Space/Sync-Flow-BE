...
export class IssueEntity implements Issue {
    ...
    title: string;
    @ApiProperty({ example: 'Implement user authentication using JWT', description: 'Detailed description of the issue' })
    ...
    projectId: string;
    @ApiProperty({ example: '123e4567-e89b-12d3-a456-4266141740C99', description: 'Identifier of the user assigned to the issue' })
